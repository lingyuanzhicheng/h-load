...
func (s *SearchAccountService) Create(ctx context.Context, account *models.GitHubSearchAccount) (*models.GitHubSearchAccount, error) {
	...
	if username, err := s.fetchUsername(ctx, account); err == nil {
...
func (s *SearchAccountService) Validate(ctx context.Context, id uint) (*models.GitHubSearchAccount, error) {
	...
	username, validateErr := s.fetchUsername(ctx, &account)
	if validateErr == nil {
		validateErr = s.validateSearchAccess(ctx, &account)
	}
	valid := validateErr == nil
	status := models.SearchAccountStatusInactive
	if valid {
		status = models.SearchAccountStatusActive
	}
...
func (s *SearchAccountService) fetchUsername(ctx context.Context, account *models.GitHubSearchAccount) (string, error) {
	...
	resp, err := s.httpClient(15 * time.Second).Do(req)
	if err != nil {
		return "", err
	}
...
func (s *SearchAccountService) validateSearchAccess(ctx context.Context, account *models.GitHubSearchAccount) error {
...
func validateSearchAccount(account *models.GitHubSearchAccount) error {
	...
	if account.Status != models.SearchAccountStatusActive && account.Status != models.SearchAccountStatusInactive {
