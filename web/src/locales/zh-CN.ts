export default {
  ...
  keys: {
    ...
    confirmClearLimitedKeys: "确定要清除所有受限密钥吗？此操作不可恢复！",
    confirmRestoreAllLimited: "确定要恢复所有受限密钥吗？",
